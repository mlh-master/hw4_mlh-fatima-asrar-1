...
loss_and_accuracy_relu = model_relu.evaluate(X_test, Y_test, verbose=2)
print(f'Loss:{loss_and_accuracy_relu [0]},Accuracy:{loss_and_accuracy_relu[1]}')
#----------------------------------------------------------------------------------------
...
if not("results" in os.listdir()):
    os.mkdir("results")
save_dir = "results/"
model_name = "initial_weigths_1.h5"
model_path = os.path.join(save_dir, model_name)
new_a_model.save(model_path)
print('Saved initialized model at %s ' % model_path)

history_25 = new_a_model.fit(BaseX_train, BaseY_train,
          batch_size=batch_size, epochs=epochs,
          validation_data=(BaseX_val, BaseY_val))

loss_and_accuracy_relu_25 = new_a_model.evaluate(X_test, Y_test)

print(f'Loss:{loss_and_accuracy_relu_25 [0]},Accuracy:{loss_and_accuracy_relu_25[1]}')
#-----------------------------------------------------------------------------------------
...
new_a_model = load_model ("results/initial_weigths_1.h5")

history_40 = new_a_model.fit(BaseX_train, BaseY_train,
          batch_size=batch_size, epochs=epochs,
          validation_data=(BaseX_val, BaseY_val))

loss_and_accuracy_relu_40 = new_a_model.evaluate(X_test, Y_test)

print(f'Loss:{loss_and_accuracy_relu_40 [0]},Accuracy:{loss_and_accuracy_relu_40[1]}')
#-----------------------------------------------------------------------------------------
...
#--------------------------Impelment your code here:-------------------------------------
model_relu.compile(optimizer=AdamOpt, metrics=['accuracy'], loss='categorical_crossentropy')
history_50 = model_relu.fit(BaseX_train, BaseY_train,batch_size=batch_size, epochs=epochs)
loss_and_accuracy_relu_50 = model_relu.evaluate(X_test, Y_test, verbose=2)
print(f'Loss:{loss_and_accuracy_relu_50 [0]},Accuracy:{loss_and_accuracy_relu_50[1]}')
#----------------------------------------------------------------------------------------
...
#--------------------------Impelment your code here:-------------------------------------
new_a_model.compile(loss='categorical_crossentropy', metrics=['accuracy'], optimizer=AdamOpt)
history_50_new = new_a_model.fit(BaseX_train, BaseY_train,batch_size=batch_size, epochs=epochs)
loss_and_accuracy_50_new = new_a_model.evaluate(X_test, Y_test, verbose=2)
print(f'Loss:{loss_and_accuracy_50_new [0]},Accuracy:{loss_and_accuracy_50_new[1]}')
#----------------------------------------------------------------------------------------
...
NNet_half =get_net(input_shape,drop,dropRate,reg)
NNet_half.compile(optimizer=AdamOpt, metrics=['acc'], loss='categorical_crossentropy')
h_half = NNet_half.fit(x=BaseX_train, y=BaseY_train, batch_size=batch_size, epochs=epochs, verbose=1, validation_split=0, validation_data = (BaseX_val, BaseY_val), shuffle=True)
results_half = NNet_half.evaluate(X_test,Y_test)
print(f'For half_filters_vec- Loss:{results_half [0]},Accuracy:{results_half[1]}')
